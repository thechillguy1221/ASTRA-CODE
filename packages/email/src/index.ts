...
export class EmailService {
  ...
  async sendVerificationOtp(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: 'Your Astra Code verification code',
      html: `<p>Use this Astra Code verification code:</p><p><strong>${escapeHtml(input.otp)}</strong></p><p>This code expires soon and can only be used once.</p>`,
  ...
  async sendWelcome(input: { userId: string; email: string }): Promise<EmailDelivery> {
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: 'Welcome to Astra Code',
      html: '<p>Welcome to Astra Code.</p><p>Build it. Understand it. Ship it.</p>',
  ...
  async sendPasswordReset(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: 'Reset your Astra Code password',
      html: `<p>We received a request to reset your Astra Code password.</p><p><a href="${escapeHtml(input.resetUrl)}">Choose a new password</a></p><p>This link expires soon and can only be used once.</p>`,
  ...
  async sendSubscriptionActivated(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: `Your Astra Code ${input.planName} plan is active`,
      html: `<p>Your Astra Code ${escapeHtml(input.planName)} plan is now active.</p><p>Your account and credits have been updated by the verified billing event.</p>`,
  ...
  async sendSubscriptionCancelled(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: 'Your Astra Code subscription was cancelled',
      html: '<p>Your Astra Code subscription cancellation was confirmed.</p><p>Any entitlement change shown in your account is based on the verified billing state.</p>',
  ...
  async sendPaymentFailed(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: 'Astra Code payment needs attention',
      html: `<p>Astra Code could not confirm your payment.</p>${billingLink}<p>Check your billing account for the current subscription state.</p>`,
  ...
  async sendRoomInvitation(input: {
    ...
    return this.send({
      ...
      verified: true,
      unsubscribed: false,
      subject: `You were invited to an Astra Code Room`,
      html: `<p>You have been invited to join the Astra Code Room <strong>${escapeHtml(input.roomName)}</strong>.</p><p><a href="${escapeHtml(input.inviteUrl)}">Join Room</a></p><p>This invitation expires according to the Room policy and can only be redeemed by the invited email address.</p>`,
